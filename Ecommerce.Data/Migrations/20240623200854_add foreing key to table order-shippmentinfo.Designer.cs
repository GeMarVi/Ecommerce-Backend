...
namespace Ecommerce.Data.Migrations
{
    ...
    [Migration("20240623200854_add foreing key to table order-shippmentinfo")]
    partial class addforeingkeytotableordershippmentinfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Model.Order", b =>
                {
                    ...
                    b.Property<Guid>("ShippmentDetail_Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Model.PaymentDetails", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PaymentDetails_Id"));
            ...
            modelBuilder.Entity("Ecommerce.Model.Order", b =>
                {
                    ...
                    b.HasOne("Ecommerce.Model.ShipmentInfo", "ShipmentInfo")
                        .WithMany("orders")
                        .HasForeignKey("ShippmentDetail_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
