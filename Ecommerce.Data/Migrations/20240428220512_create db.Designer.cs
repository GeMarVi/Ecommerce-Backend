...
namespace Ecommerce.Data.Migrations
{
    ...
    [Migration("20240428220512_create db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Shared.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Shared.ImagesProduct", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Shared.OrderStatus", b =>
                {
                    b.Property<int>("OrderStatus_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Shared.ProductEvaluation", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Shared.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Shared.SizeStock", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Shared.Tax", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Shared.UserPaymentInformation", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Shared.Order", b =>
                {
                    b.HasOne("Ecommerce.Shared.OrderStatus", "OrderStatus")
                        .WithMany("Orders")
                    ...
                    b.HasOne("Ecommerce.Shared.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Shared.ProductEvaluation", b =>
                {
                    b.HasOne("Ecommerce.Shared.Order", "Order")
                        .WithOne("ProductEvaluation")
                        .HasForeignKey("Ecommerce.Shared.ProductEvaluation", "Order_Id");
                    ...
                    b.HasOne("Ecommerce.Shared.ApplicationUser", "user")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Shared.Tax", b =>
                {
                    b.HasOne("Ecommerce.Shared.ApplicationUser", "Client")
                        .WithOne("Tax")
                        .HasForeignKey("Ecommerce.Shared.Tax", "Client_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ecommerce.Shared.UserPaymentInformation", b =>
                {
                    b.HasOne("Ecommerce.Shared.ApplicationUser", "User")
                        ...
                        .HasForeignKey("Ecommerce.Shared.UserPaymentInformation", "User_Id");
            ...
            modelBuilder.Entity("Ecommerce.Shared.Order", b =>
                {
                    b.Navigation("ProductEvaluation");
                });
